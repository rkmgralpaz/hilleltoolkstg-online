...
<div class="js-module block-data-interactive-main-graphs theme theme--neutral">
    ...
    $subtypes_start_year = get_field('subtypes_start_year', 'data_interactive');
    $subtypes_disclaimer_text = get_field('subtypes_disclaimer_text', 'data_interactive') .' '. $subtypes_start_year;
    ...
    <div class="main-graphs font-body-sm" data-animate="fade-up" data-animate-delay="500">
        ...
        <div class="main-graphs__tabs">
            ...
            <button class="main-graphs__tab" data-target="<?= $graph_2_id; ?>" aria-label="Explore trends by type of incident">Incident Types</button>
        ...
        <div class="main-graphs__holder">
            ...
            <div id="<?= $graph_1_id; ?>" class="graph-incidents">
                ...
                <div class="graph-incidents__scroller hide-scrollbar">
                    <div class="graph-incidents__wrapper">
                        ...
                        <div class="graph-incidents__dotted-line font-body-xs"></div>
                    </div>
                ...
                <div class="graph-incidents__details-wrapper">
                    <div class="graph-incidents__details">
                        ...
                        <div class="graph-incidents__details-period">Incidents in <span></span> school year</div>
                        <div class="graph-incidents__details-number"></div>
                        <div class="graph-incidents__details-percent">
                            <div class="graph-incidents__details-percent-num">
                                <div class="graph-incidents__details-percent-num-icon icon__arrow">
                                ...
                                <div class="graph-incidents__details-percent-num-icon icon__equal">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <line class="st0" x1="7" y1="10" x2="17" y2="10" stroke-width="1.5" stroke="#4B7EFD"/>
                                        <line class="st0" x1="7" y1="14" x2="17" y2="14" stroke-width="1.5" stroke="#4B7EFD"/>
                                    </svg>
                                </div>
                                <div class="graph-incidents__details-percent-num-txt"></div>
                            </div>
                            <div class="graph-incidents__details-percent-text">
                                <span class="txt__equal">as previous year</span>
                                <span class="txt__default">from previous year</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="graph-incidents__tooltip font-body-xs">
                    <div class="graph-incidents__tooltip-holder">
                        ...
                        <div class="graph-incidents__tooltip-percent-num">
                            ...
                            <div class="graph-incidents__tooltip-percent-num-txt"></div>
                        </div>
                        <?php
            ...
            <div id="<?= $graph_2_id; ?>" class="graph-incidents-subtypes" data-subtypes-start-year="<?= $subtypes_start_year; ?>">
                ...
                <div class="graph-incidents-subtypes__scroller hide-scrollbar">
                    <div class="graph-incidents-subtypes__wrapper">
                        ...
                        <div class="graph-incidents-subtypes__dotted-line font-body-xs"></div>
                        <div class="graph-incidents-subtypes__solid-line font-body-xs">
                            ...
                            <div class="graph-incidents-subtypes__tooltip">
                                <div class="graph-incidents-subtypes__tooltip-holder">
                                    ...
                                    <div class="graph-incidents-subtypes__tooltip-percent-num">
                                        <div class="graph-incidents-subtypes__details-percent-num-icon icon__arrow">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="13" viewBox="0 0 10 13" fill="none">
                                                <path d="M5 11.4999V2.23096" stroke="#FF1C20" stroke-width="1.5" stroke-linecap="square"/>
                                                <path d="M1.13867 5.36207L5.00075 1.5L8.86282 5.36207" stroke="#FF1C20" stroke-width="1.5" stroke-linecap="square"/>
                                            </svg>
                                        </div>
                                        <div class="graph-incidents-subtypes__details-percent-num-icon icon__equal">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <line class="st0" x1="7" y1="10" x2="17" y2="10" stroke-width="1.5" stroke="#4B7EFD"/>
                                                <line class="st0" x1="7" y1="14" x2="17" y2="14" stroke-width="1.5" stroke="#4B7EFD"/>
                                            </svg>
                                        </div>
                                        <div class="graph-incidents-subtypes__tooltip-percent-num-txt"></div>
                                    </div>
                                    <?php
                                    echo get_button(array(
                                        'href' => '#',
