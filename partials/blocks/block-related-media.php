<div id="block-<?php echo $block_index; ?>"
    class="theme <?php echo explode(';', $block['module_configuration']['color_palette'])[0]; ?> <?php echo isset($block['module_configuration']['color_mode']) ? $block['module_configuration']['color_mode'] : 'theme--light'; ?>">
    ...
    <div class="block-related-media max-width">
        ...
        <div>
            ...
            <?php if (!empty($block['text'])): ?>
                <div class="block-related-media__main-text font-body-md theme__text--secondary" data-animate="fade-in-up"
        ...
        <?php if (!empty($block['show_media_library_button'])): ?>
            <div class="block-related-media__cta" data-animate="fade-in-up">
                ...
                echo get_button(array(
                    'html_text' => $block['media_library_button_text'],
