			...
			<div class="block-datawrapper-2__body">
				...
				<?php  foreach ($data_array as $rango_years => $data) {  ?>
					...
					<div class="bar-graph__bar" data-animate="fade-in-up" data-animate-delay="100">
						...
						<div class="bar-graph__candle bar-graph__candle-2" style="width: <?php echo round($data['percentage_of_max']); ?>%; height: calc( <?php echo round($data['percentage_of_max']); ?>% - 50px)">
						</div>
