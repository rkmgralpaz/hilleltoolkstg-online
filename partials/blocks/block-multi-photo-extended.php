<?php
$block_classes = 'js-module block-multi-photo-extended theme theme--neutral ';
...
<div id="block-<?php echo $block_index; ?>" class="<?php echo $block_classes; ?>">
    <div class="block-multi-photo-extended__texts">

        <?php
        echo get_dynamic_heading(
            $block['title'],
            $block['heading_tag'],
            'block-multi-photo-extended__title font-display-md theme__text--primary',
            [
        ...
        <div class="block-multi-photo-extended__copy font-body-lg theme__text--secondary" data-animate="fade-in-up" data-animate-delay="200">
            <?php echo $block['text']; ?>
        </div>
        <?php if ($has_buttons): ?>
            <div class="block-multi-photo-extended__buttons" data-animate="fade-in-up" data-animate-delay="300">
                <?php
                if ($has_button_1):
    ...
    <div class="block-multi-photo-extended__images">
        ...
        <div class="images__image images__image--6">
            <div class="image__img"></div>
        </div>
        <div class="images__image images__image--7">
            <div class="image__img"></div>
        </div>
    </div>
