...
<div class="block-datawrapper-2-wrap theme theme--neutral theme--mode-light">

	<div class="block-datawrapper-2 <?php echo $block['padding_bottom'] ? 'block-datawrapper-2--pb' : ''; ?>">

        <div class="block-datawrapper-2__divider"></div>

        <div class="block-datawrapper-2__top max-width">

            <div class="block-datawrapper-2__title" data-animate="fade-in-up">
                <h2 class="font-heading-md theme__text--primary">
				<?php echo esc_html(wp_strip_all_tags($chart_title)); ?>

                </h2>
            </div>

            <div class="block-datawrapper-2__source block-datawrapper-2__source--desktop font-body-sm theme__text--secondary" data-animate="fade-in-up">
                <div>
		...
		<div class="block-datawrapper-2__body-wrap">

			<div class="block-datawrapper-2__body">
				...
				<?php  foreach ($data_array as $rango_years => $data) {  ?>
					...
					<div class="bar-graph__bar" data-animate="fade-in-up" data-animate-delay="100">
						...
						<div class="bar-graph__candle bar-graph__candle-2" style="height: <?php echo round($data['percentage_of_max']); ?>%; width: calc( <?php echo round($data['percentage_of_max']); ?>% - 10px)">
						</div>
			...
			<div class="block-datawrapper-2__bottom">
				<div>
				<?php foreach ($data_array as $rango_years => $data) { ?>
					<div class="theme__text--secondary">
					<div class="block-datawrapper-2__year">
						<?php echo $rango_years; ?>
					</div>
		...
		<div class="block-datawrapper-2__mobile">

		<div class="block-datawrapper-2__divider"></div>
			<div class="block-datawrapper-2__source block-datawrapper-2__source--mobile font-body-sm theme__text--secondary" data-animate="fade-in-up">
				<div>
				<?php echo $chart_notes;  ?>          
				</div>
				<div>
