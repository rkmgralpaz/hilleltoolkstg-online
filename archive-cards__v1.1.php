...
<div class='page-cards js-module theme theme--pink theme--mode-neutral'>
    ...
    <div class='block block-cards js-module block-cards--total-{$total_cards} {$cards_classes}'>
        
        <div class='block-cards__bottom-area theme theme--neutral theme--mode-light' data-animate='fade-in-up' data-animate-delay='300'>
            {$more_cards_btn}
            <div class='block-cards__share-global'>
                {$share_all_btn}
                <div class='block-cards__share-all-cards'>
                    <div class='block-cards__share-link-options' data=slug='hello-world'>
            ...
            <div class='block-cards__flipped-num block-cards__flipped-num--desktop'>01/08</div>
        </div>
    ...
    foreach ($card_list as $card):
        ...
        $cards_html .= "
        <div id='card{$card}' class='block-cards__card block-cards--card-hidden block-cards--card-{$card_num}' data-slug='{$card_slug}' data-card-num='{$index}'>
            <div class='card__holder'>
                            ...
                            <div class='card__scroller'>
                                <div class='face-back__left'>
                                    <div class='face-back__title font-display-sm face-back--elem-fadeable'>
                                        ".str_replace('h2','div',$card_heading_back)."
                ...
                <a href='{$card_permalink}' class='card__area-btn ' aria-label='Flip card'></a>
